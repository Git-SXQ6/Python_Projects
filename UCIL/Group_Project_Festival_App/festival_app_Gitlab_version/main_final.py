# This version has all needed prompts 
...
accommodation_dropdown = ttk.Combobox(header_frame, textvariable=accommodation_var, values=["Camping", "Hotel", "Hostel"])
...
# BUG (): remove duplicate, auto clear input, check data type
def add_festival_goer():
    ...
    if data_handler.is_duplicate(name, age, distance, accommodation, ticket_type):
